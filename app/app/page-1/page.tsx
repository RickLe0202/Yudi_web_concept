...
export default function Page1() {
  ...
  return (
    <div className="flex h-[88vh] w-full max-w-7xl mx-auto overflow-hidden rounded-[2.5rem] 
      ...
      {/* 1. LEFT MINI SIDEBAR (Icons Only) */}
      <aside className="w-20 border-r border-white/10 flex flex-col items-center py-8 gap-8 bg-white/20 dark:bg-black/20">
        ...
        <nav className="flex flex-col gap-6 mt-4">
          ...
          <Link href="/app/page-2" className="p-3 rounded-xl hover:bg-white/10 transition-all text-xl">🧭</Link>
          <Link href="/app/page-3" className="p-3 rounded-xl hover:bg-white/10 transition-all text-xl">✨</Link>
          <button className="p-3 rounded-xl hover:bg-white/10 transition-all text-xl mt-auto">⚙️</button>
        </nav>
      </aside>

      {/* 2. CHAT LIST COLUMN */}
      <section className="w-80 md:w-96 border-r border-white/10 flex flex-col bg-white/10 dark:bg-black/5">
        <div className="p-6">
